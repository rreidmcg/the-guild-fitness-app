...
const ERANK_DUNGEON_ZONES: DungeonZone[] = [
  {
    ...
    monsters: [
      ...
      { id: 2, name: "Green Slime", level: 1, maxHp: 15, currentHp: 15, attack: 3, goldReward: 1, description: "A larger, more aggressive gelatinous creature", image: greenSlimeImage },
      { id: 3, name: "Acidic Slime", level: 1, maxHp: 18, currentHp: 18, attack: 4, goldReward: 2, description: "A corrosive slime that burns through metal", image: greenSlimeImage },
      { id: 4, name: "Bouncing Slime", level: 2, maxHp: 21, currentHp: 21, attack: 4, goldReward: 2, description: "An energetic slime that ricochets off walls", image: greenSlimeImage },
      { id: 5, name: "Elder Slime", level: 2, maxHp: 24, currentHp: 24, attack: 5, goldReward: 3, description: "An ancient slime with crystalline formations", image: greenSlimeImage },
      { id: 6, name: "Slime King", level: 2, maxHp: 30, currentHp: 30, attack: 5, goldReward: 5, description: "🏆 MINI-BOSS: The ruler of the slime caverns, pulsing with ancient power", image: slimeKingImage }
    ]
  },
  {
    id: "rat_warrens",
    ...
    monsters: [
      ...
      { id: 8, name: "Cave Rat", level: 2, maxHp: 21, currentHp: 21, attack: 4, goldReward: 2, description: "A larger rat adapted to cave life", image: caveRatImage },
      { id: 9, name: "Plague Rat", level: 2, maxHp: 24, currentHp: 24, attack: 5, goldReward: 3, description: "A sickly rat spreading corruption", image: caveRatImage },
      { id: 10, name: "Giant Rat", level: 3, maxHp: 27, currentHp: 27, attack: 5, goldReward: 3, description: "An oversized rodent with massive claws", image: caveRatImage },
      { id: 11, name: "War Rat", level: 3, maxHp: 30, currentHp: 30, attack: 6, goldReward: 4, description: "A battle-scarred rat veteran", image: caveRatImage },
      { id: 12, name: "Rat Chieftain", level: 3, maxHp: 39, currentHp: 39, attack: 6, goldReward: 6, description: "🏆 MINI-BOSS: A massive rat wearing crude armor, leading its pack", image: ratChieftainImage }
    ]
  },
  {
    id: "goblin_outpost",
    ...
    monsters: [
      { id: 13, name: "Goblin Scout", level: 2, maxHp: 21, currentHp: 21, attack: 5, goldReward: 3, description: "A sneaky goblin carrying a rusty knife", image: wildGoblinImage },
      { id: 14, name: "Wild Goblin", level: 3, maxHp: 24, currentHp: 24, attack: 5, goldReward: 3, description: "A fierce goblin warrior with crude weapons", image: wildGoblinImage },
      { id: 15, name: "Goblin Raider", level: 3, maxHp: 27, currentHp: 27, attack: 6, goldReward: 4, description: "A goblin armed with stolen gear", image: wildGoblinImage },
      { id: 16, name: "Goblin Shaman", level: 3, maxHp: 30, currentHp: 30, attack: 6, goldReward: 4, description: "A goblin mystic wielding dark magic", image: wildGoblinImage },
      { id: 17, name: "Goblin Captain", level: 4, maxHp: 33, currentHp: 33, attack: 9, goldReward: 5, description: "A goblin officer commanding the troops", image: wildGoblinImage },
      { id: 18, name: "Goblin Warlord", level: 4, maxHp: 42, currentHp: 42, attack: 9, goldReward: 7, description: "🏆 MINI-BOSS: A battle-scarred goblin chief with stolen armor and weapons" }
    ]
  },
  {
    id: "spider_nest",
    ...
    monsters: [
      { id: 19, name: "Web Spinner", level: 3, maxHp: 27, currentHp: 27, attack: 6, goldReward: 4, description: "A quick spider that weaves binding webs", image: forestSpiderImage },
      { id: 20, name: "Forest Spider", level: 4, maxHp: 30, currentHp: 30, attack: 6, goldReward: 4, description: "A venomous hunter with razor-sharp fangs", image: forestSpiderImage },
      { id: 21, name: "Poison Spider", level: 4, maxHp: 33, currentHp: 33, attack: 9, goldReward: 5, description: "A deadly arachnid dripping with venom", image: forestSpiderImage },
      { id: 22, name: "Shadow Spider", level: 4, maxHp: 36, currentHp: 36, attack: 9, goldReward: 5, description: "A spider that strikes from the darkness", image: forestSpiderImage },
      { id: 23, name: "Warrior Spider", level: 5, maxHp: 39, currentHp: 39, attack: 10, goldReward: 6, description: "A heavily armored spider guardian", image: forestSpiderImage },
      { id: 24, name: "Broodmother", level: 5, maxHp: 48, currentHp: 48, attack: 10, goldReward: 8, description: "🏆 MINI-BOSS: An enormous spider surrounded by her countless offspring" }
    ]
  }
];
