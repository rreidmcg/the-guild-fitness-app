...
const ERANK_DUNGEON_ZONES: DungeonZone[] = [
  {
    ...
    monsters: [
      { id: 1, name: "Tiny Slime", level: 2, maxHp: 18, currentHp: 18, attack: 3, goldReward: 2, description: "A small, translucent blob that quivers nervously", image: greenSlimeImage },
      { id: 2, name: "Green Slime", level: 3, maxHp: 28, currentHp: 28, attack: 4, goldReward: 3, description: "A larger, more aggressive gelatinous creature", image: greenSlimeImage },
      { id: 3, name: "Slime King", level: 4, maxHp: 42, currentHp: 42, attack: 6, goldReward: 6, description: "🏆 MINI-BOSS: The ruler of the slime caverns, pulsing with ancient power" }
    ]
  },
  {
    id: "rat_warrens",
    ...
    monsters: [
      { id: 4, name: "Sewer Rat", level: 3, maxHp: 22, currentHp: 22, attack: 4, goldReward: 3, description: "A disease-ridden rodent with yellowed fangs", image: caveRatImage },
      { id: 5, name: "Cave Rat", level: 4, maxHp: 32, currentHp: 32, attack: 5, goldReward: 4, description: "A larger rat adapted to cave life", image: caveRatImage },
      { id: 6, name: "Rat Chieftain", level: 5, maxHp: 48, currentHp: 48, attack: 7, goldReward: 7, description: "🏆 MINI-BOSS: A massive rat wearing crude armor, leading its pack" }
    ]
  },
  {
    id: "goblin_outpost",
    ...
    monsters: [
      { id: 7, name: "Goblin Scout", level: 4, maxHp: 28, currentHp: 28, attack: 5, goldReward: 4, description: "A sneaky goblin carrying a rusty knife", image: wildGoblinImage },
      { id: 8, name: "Wild Goblin", level: 5, maxHp: 38, currentHp: 38, attack: 6, goldReward: 5, description: "A fierce goblin warrior with crude weapons", image: wildGoblinImage },
      { id: 9, name: "Goblin Warlord", level: 6, maxHp: 58, currentHp: 58, attack: 8, goldReward: 8, description: "🏆 MINI-BOSS: A battle-scarred goblin chief with stolen armor and weapons" }
    ]
  },
  {
    id: "spider_nest",
    ...
    monsters: [
      { id: 10, name: "Web Spinner", level: 5, maxHp: 35, currentHp: 35, attack: 6, goldReward: 5, description: "A quick spider that weaves binding webs", image: forestSpiderImage },
      { id: 11, name: "Forest Spider", level: 6, maxHp: 45, currentHp: 45, attack: 7, goldReward: 6, description: "A venomous hunter with razor-sharp fangs", image: forestSpiderImage },
      { id: 12, name: "Broodmother", level: 7, maxHp: 68, currentHp: 68, attack: 9, goldReward: 10, description: "🏆 MINI-BOSS: An enormous spider surrounded by her countless offspring" }
    ]
  }
];
