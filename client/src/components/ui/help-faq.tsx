...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Daily quests are simple health habits: drinking water (hydration), taking steps, eating protein, and getting good sleep. Complete individual quests for 5 XP each, finish all 4 for bonus XP, and complete 3+ quests to earn streak freezes. They reset every day at midnight in your timezone.",
  ...
  },
  {
    ...
    answer: "Maintain your streak by completing workouts (minimum activity required to advance). Streaks give XP multipliers (1.5x at 3+ days) and unlock special rewards. Complete 3+ daily quests to earn streak freezes that protect your progress during rest days or busy periods.",
    category: "Streaks",
    icon: Calendar
  },
  {
    ...
    answer: "After 2 consecutive days of complete inactivity (no workouts AND less than 3 daily quests), you'll start losing 1% XP and stats daily. New players get protection for their first week. Use streak freezes or maintain minimal activity to prevent this.",
